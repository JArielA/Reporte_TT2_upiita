...
\Presidente{Dr. Juan Carlos Guzmán Salgado}
\Titular{Ing. Octavio Montes Campuzano}
%%%%%%%%%%%%%%%%%%%%%%% Datos del autor%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\alumnoa{Marco Antonio Alcaráz Castillo}
\alumnob{Jesús Ariel Almaguer Martínez}
\alumnoc{Daniel Judá Castañeda Cortés}
...
\asesora{Ing. Emilio Nicéforo Brito Martínez}
\asesorb{Dr. Ottmar Raúl Reyes López}
...
\include{parts/2_Dis_sist/2_Dis_sis}
...
\part{Apéndices}
\appendix
\include{apendices/apendices/7.2.1_IDEF}
\include{apendices/apendices/7.2.2_Matriz_Morfologica}
\include{apendices/apendices/7.2.3_Criterios_de_Seleccion}
\include{apendices/apendices/7.2.4_Matrices_AHP}
\include{apendices/apendices/7.2.5_Seleccion}
\include{apendices/apendices/7.2.6_Temperatura_cilindro}
\include{apendices/apendices/7.2.7_Temperatura_final}
\include{apendices/apendices/7.2.8_Estudios_Termicos}
\include{apendices/apendices/7.2.9_Calculos_estructura}
\include{apendices/apendices/7.2.10_Control}
\include{apendices/apendices/7.2.11_Ventilacion}
\include{apendices/apendices/7.2.12_Codigo_de_programa}
