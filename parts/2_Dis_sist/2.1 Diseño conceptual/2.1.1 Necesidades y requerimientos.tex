...
\begin{table}
  ...
  \begin{tabularx}{\linewidth}{|c|X|c|c|c|c|}
    ...
    R3 & Realizar el control de temperatura de acuerdo con las fases del proceso & & X & 5 & \makecell{ -Fase Mesófila I: 25-45 $^oC$  \\ -Fase Termófila: 45-60 $^oC$ \\ -Fase Mesófila II: 45-30 $^oC$ } \\ \hline
