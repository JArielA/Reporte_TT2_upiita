...
Para la implementación, se realizó un código (Apéndice \ref{Ap:Codigo_completo}) en lenguaje C a través de la interfaz de Arduino 2.0. El código está formado por 4 hilos, que son diferentes rutinas que se ejecutan de manera simultánea dentro de los procesadores del microcontrolador.
...
Para poder interactuar con el dispositivo, dentro del hilo principal se ha implementado una interfaz (figura \ref{fg:cto_interfaz_fisico}), aquí se han colocado los botones (Figura \ref{fg:botones_imp}), para permitir que el usuario demande información que estará disponible por medio de un menú.
...
\clearpage
Cada uno de los botones representará una de las opciones que se encontrarán en el menú (figura \ref{fg:menu_interfaz}) a través de la cual se podrá consultar información relevante acerca del ciclo de procesamiento del compost. Por ejemplo, los mensajes mostrados en las figuras \ref{fg:tiempo_proceso} y \ref{fg:proceso_en_ejecucion}.
...
\begin{figure}[h]
        ...
        \end{figure}
                ...
                \begin{figure}[h]
               \centering
            \includegraphics[scale=0.5]{images/Web/indicador.png}
...
\begin{figure}[h]
            \centering
            \includegraphics[scale=0.5]{images/Web/indicador_temp.png}
...
\begin{figure}[h]
            \centering
            \includegraphics[scale=0.45]{images/Web/error_ds18.png}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[scale=0.45]{images/Web/dht11_web.png}
...
\begin{figure}[H]
            \centering
            \includegraphics[scale=0.5]{images/Web/ventilador_web.png}
...
\begin{figure}[H]
            \centering
            \includegraphics[scale=0.5]{images/Web/motor_web.png}
...
\begin{figure}[H]
            \centering
            \includegraphics[scale=0.5]{images/Web/resistencia_web.png}
...
Por último para saber en qué punto del proceso se encuentra, se colocó un temporizador regresivo que mediante el almacenamiento local de la página registra la hora y aunque el sitio web se actualiza, el temporizador no se reinicia.


\begin{figure}[h]
            \centering
            \includegraphics[scale=0.5]{images/Web/temporizador_web.png}
...
\begin{figure}[H]
            \centering
            \includegraphics[scale=0.4]{images/Web/Db_compostador.png}
