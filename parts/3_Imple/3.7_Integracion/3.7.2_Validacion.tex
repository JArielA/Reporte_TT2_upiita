...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.18]{images/Pruebas/Pruebas_compost/carga2.jpeg}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.11]{images/Pruebas/Pruebas_compost/carga3.jpeg}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.11]{images/Pruebas/Pruebas_compost/descarga3.jpeg}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.18]{images/Pruebas/Pruebas_compost/descarga6.jpeg}
...
En síntesis, las pruebas 1 y 2 presentaron exceso de humedad no corregido, con pH de 8.83 y 7.96. La prueba 3 destacó por sus condiciones óptimas ---trituración fina, humedad mínima y pH de 7.62---, siendo la más cercana a la neutralidad. La prueba 4 alcanzó un pH de 5.33 con preparación mixta, mientras que la prueba 5 registró un pH de 7.15 y el mayor rendimiento (48.4\,\%). La prueba 6, al ser interrumpida, carece de medición y registro fotográfico. Estos resultados correlacionan las condiciones de procesamiento con la estabilidad de cada muestra y sustentan la validación del compost.