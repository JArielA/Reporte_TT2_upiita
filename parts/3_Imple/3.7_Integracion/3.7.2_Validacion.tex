...
La Figura \ref{fg:muestra1_proceso} muestra el aspecto de esta muestra durante el pesaje, la comparación colorimétrica y la lectura del pHmetro. 

La segunda muestra, asociada a la prueba 2, mantuvo la misma problemática de humedad excesiva que la primera, sin que se lograra reducir el agua durante el proceso. Aunque no se reportó la cantidad de compost obtenido, el pH final fue de 7.3, ligeramente superior al de la muestra anterior.
...
La cuarta muestra (prueba 4) correspondió a una preparación mixta: la mitad de los residuos fue triturada y la otra mitad picada. El compost resultante fue homogéneo, con humedad moderada y un olor frutal agradable, alcanzando un pH de 7.4.
