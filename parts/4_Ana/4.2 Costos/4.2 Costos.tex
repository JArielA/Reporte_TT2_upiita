...
En esta parte se realiza el desglose de los costes del proyecto, en este se dividen los gastos en diferentes apartados, para sintetizar mejor las cuentas.  Los diferentes apartados en los que se dividen los gastos son:
\begin{itemize}
    ...
    \item Materiales \ref{tab:mat_cost}. Se en listan los perfiles, fibras, varillas y placas que se utilizaron.
...
\end{table}
A partir de los dato de la tabla \ref{tab:gastototal}, se puede obtener la gráfica de la ilustración \ref{fg:rep_gastos}, en la que se muestra de que manera se realizo el reparto de los gastos, siendo, los materiales y los componentes mecánicos los que acaparan la mayoría de la inversión hecha, representando el 59 \% de la inversión total. Mientras que el gasto en la herramienta y accesorios utilizados es mínimo, debido al apoyo que se brindo por parte del laboratorio de Trabajo Terminal.
\begin{figure}[h!]
    \centering
