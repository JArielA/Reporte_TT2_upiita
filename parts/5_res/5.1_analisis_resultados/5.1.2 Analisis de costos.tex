...
En esta parte se realiza el desglose de los costes del proyecto, el cual está dividido en 3 partes, los materiales y componentes (Tabla \ref{tab:cost_mat}), las herramientas y equipo (Tabla \ref{tab:cost_herramientas}), y por último, la manufactura externa que será requerida (Tabla \ref{tab:cost_manodeobra}).
